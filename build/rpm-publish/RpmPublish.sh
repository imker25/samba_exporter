...
if [ "$distribution" == "Fedora" ] && [ "$distVersionNumber" == "37" ]; then
    echo "Do modifications for 'Fedora 37'"
...
if [ "$distribution" == "Fedora" ] && [ "$distVersionNumber" == "40" ]; then
    echo "Do modifications for 'Fedora 40'"
    sed -i "s/Release: 1/Release: 1.fc40/g" ~/rpmbuild/SPECS/samba-exporter.spec
    buildSystem="rpm"
    changeroots="--chroot fedora-${distVersionNumber}-x86_64"
    coprUpload="true"
else
...
if [ "$distribution" == "Fedora" ] && [ "$distVersionNumber" == "42" ]; then
    ...
    echo "Not running on Fedora 42"
fi

if [ "$distribution" == "Fedora" ] && [ "$distVersionNumber" == "43" ]; then
    echo "Do modifications for 'Fedora 43'"
    sed -i "s/Release: 1/Release: 1.fc43/g" ~/rpmbuild/SPECS/samba-exporter.spec
    buildSystem="rpm"
    changeroots="--chroot fedora-${distVersionNumber}-x86_64"
    coprUpload="true"
else
