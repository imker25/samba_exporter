...
const TestLockResponse = `Locked files:
...
const TestServiceResponse = `Service      pid     Machine       Connected at                     Encryption   Signing     
---------------------------------------------------------------------------------------------
IPC$         1119    192.168.1.242  Sun May 16 11:55:36 AM 2021 CEST -            -           `

// Contains the test data for a Process Response
const TestProcessResponse = `Samba version 4.11.6-Ubuntu
